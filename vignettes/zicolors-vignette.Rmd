...
Die Installation des Stiles ist innerhalb des Zi-Netzwerks bereits erfolgt. Auf externen Geräten (Ausnahme!) kann `devtools` benutzt werden, um das Paket direkt von Github zu installieren.
