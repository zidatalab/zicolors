...
Hinweis: Falls der Fehler "Found FontName for 0 fonts" bzw "No FontName. Skipping." beim font_import() auftritt, muss folgendes ausgeführt werden (alle Betriebssysteme): library(remotes), dann remotes::install_version("Rttf2pt1", version = "1.3.8").
