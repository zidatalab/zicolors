...
zi_colors <- c(
  ...
  `zihimmelblaudunkel`    = rgb(48/255,105/255,198/255), # "#3069c6"
  `zilindgruendunkel`     = rgb(31/255,144/255,81/255), # "#1f9051"
  `zihimmelblauhell`      = rgb(190/255,224/254,255/255), # "#bee0fe"
  `zilindgruenhell`       = rgb(192/255,237/255,206/255), # "#c0edce"
